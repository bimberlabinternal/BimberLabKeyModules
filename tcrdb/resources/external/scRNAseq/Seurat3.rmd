...
for (v in c('outPrefix', 'resolutionToUse', 'dimsToUse', 'minDimsToUse', 'doCellFilter', 'doCellCycle', 'useSCTransform', 'runSingleR', 'mergeMethod', 'skipProcessing')){
    if (exists(v)){
...
```{r InitialProcessing, fig.width=10}
