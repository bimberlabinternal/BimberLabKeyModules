...
package org.labkey.test.components.mcc;
 ...
 */
public class MccWebPart extends BodyWebPart<MccWebPart.ElementCache>
{
    public MccWebPart(WebDriver driver)
    {
        this(driver, 0);
    }

    public MccWebPart(WebDriver driver, int index)
    {
        super(driver, "Mcc", index);
    }

    public MccWebPart setInput(String value)
    {
