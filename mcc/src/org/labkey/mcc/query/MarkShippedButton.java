...
public class MarkShippedButton extends SimpleButtonConfigFactory
{
    ...
    {
        super(ModuleLoader.getInstance().getModule(MccModule.class), "Mark Animal Shipped", "MCC.window.MarkShippedWindow.buttonHandler(dataRegionName);", Arrays.asList(ClientDependency.supplierFromPath("mcc/window/MarkShippedWindow.js")));
