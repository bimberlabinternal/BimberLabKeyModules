      ...
      {[...coInvestigators].map((uuid, index) => (
        <div className="tw-flex tw-flex-wrap tw-w-full tw-mx-2 tw-mb-10" key={uuid}>
          ...
          <div className="tw-w-full md:tw-w-1/3 tw-px-3 md:tw-mb-0">
            <Input id={"coinvestigators-" + index + "-" + "lastName"} isSubmitting={props.isSubmitting} placeholder="Last Name" />
          </div>

          <div className="tw-w-full md:tw-w-1/3 tw-px-3 tw-mb-6 md:tw-mb-0">
            <Input id={"coinvestigators-" + index + "-" + "firstName"} isSubmitting={props.isSubmitting} placeholder="First Name" />
          </div>

          <div className="tw-w-full md:tw-w-1/3 tw-px-3 tw-mb-6 md:tw-mb-0">
            <Input id={"coinvestigators-" + index + "-" + "middleInitial"} isSubmitting={props.isSubmitting} placeholder="Middle Initial" />
          </div>

          <div className="tw-w-full tw-px-3 tw-mb-6 md:tw-mb-0">
            <Input id={"coinvestigators-" + index + "-" + "institution"} isSubmitting={props.isSubmitting} placeholder="Institution" />
          </div>
        </div>
      ))}
