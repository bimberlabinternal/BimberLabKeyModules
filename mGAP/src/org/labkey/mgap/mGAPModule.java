...
public class mGAPModule extends ExtendedSimpleModule
{
    ...
    public void doStartupAfterSpringConfig(ModuleContext moduleContext)
    {
        ...
        ContentSecurityPolicyFilter.registerAllowedSources(this.getClass().getName(), Directive.Connection, "https://code.jquery.com", "https://*.fontawesome.com", "https://cdn.jsdelivr.net");
        ContentSecurityPolicyFilter.registerAllowedSources(this.getClass().getName(), Directive.Style, "https://code.jquery.com", "https://www.gstatic.com", "https://fonts.googleapis.com", "https://cdn.jsdelivr.net");
