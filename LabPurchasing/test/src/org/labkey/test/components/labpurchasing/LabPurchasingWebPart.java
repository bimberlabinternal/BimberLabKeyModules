...
package org.labkey.test.components.labpurchasing;
 ...
 */
public class LabPurchasingWebPart extends BodyWebPart<LabPurchasingWebPart.ElementCache>
{
    public LabPurchasingWebPart(WebDriver driver)
    {
        this(driver, 0);
    }

    public LabPurchasingWebPart(WebDriver driver, int index)
    {
        super(driver, "LabPurchasing", index);
    }

    public LabPurchasingWebPart setInput(String value)
    {
