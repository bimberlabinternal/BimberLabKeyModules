...
public class MethylationRateComparisonHandler implements SequenceOutputHandler<SequenceOutputHandler.SequenceOutputProcessor>
{
    ...
    {
        return DetailsURL.fromString("/primeseq/methylationRateComparison.view?outputFileIds=" + StringUtils.join(outputFileIds, ";"), c).getActionURL();
    }

    @Override
    public Module getOwningModule()
    {
        return ModuleLoader.getInstance().getModule(PrimeseqModule.class);
    }
    ...
    public class Processor implements SequenceOutputProcessor
    {
        ...
        private String getScriptPath() throws PipelineJobException
        {
            ...
            Module module = ModuleLoader.getInstance().getModule(PrimeseqModule.NAME);
            Resource script = module.getModuleResource(path);
            if (script == null || !script.exists())
                throw new PipelineJobException("Unable to find file: " + script.getPath() + " in module: " + PrimeseqModule.NAME);
