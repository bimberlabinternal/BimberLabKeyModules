...
public class PrimeseqController extends SpringActionController
{
    ...
    @UtilityAction(label = "Perform MHC Cleanup", description = "This will run a pipeline job to delete low-frequency MHC results to save space")
